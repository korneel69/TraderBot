...
def balance_order_buy_spot(self,multiplier):
    ...
    print('Balancing: buy spot',self._future,'| balance future vs spot: ',self._futureBalance,self._spotBalance,'| price: ',self.spot_ask,'| size: ',size*multiplier)
...
def balance_order_buy_future(self,multiplier):
    ...
    print('Balancing: buy future',self._future,'| balance future vs spot: ',self._futureBalance,self._spotBalance,'| price: ',self.future_ask,'| size: ',size*multiplier)
...
def balance_order_sell_spot(self,multiplier):
    ...
    print('Balancing: sell spot',self._future,'| balance future vs spot: ',self._futureBalance,self._spotBalance,'| price: ',self.spot_bid,'| size: ',size*multiplier)
...
def balance_order_sell_future(self,multiplier):
    ...
    print('Balancing: sell future',self._future,'| balance future vs spot: ',self._futureBalance,self._spotBalance,'| price: ',self.future_bid,'| size: ',size*multiplier)
...
def make_balancing_order(self):
        multiplier1=int(max(abs(self._balanceDifference//5),100))
        multiplier2=int(max(abs(self._balanceDifference//5),10))
        multiplier3=int(max(abs(self._balanceDifference//5),1))
