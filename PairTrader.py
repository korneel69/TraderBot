...
class PairTrader():
    ...
    def calculate_potential(self):
        ...
        #Added ask here as a test, if successfull, add bid as well
        self.ratioAskWeight=1+(self.ratioAsk-1)*((1+self.collateralWeight)/2)
        spread=(1+self.ratioAsk-self.ratioBid)
        self.ratioAskWeight=self.ratioAskWeight*spread
